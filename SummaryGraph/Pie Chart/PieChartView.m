...
- (void)drawRect:(CGRect)rect {
    ...
    NSArray * RedAarray = @[@"63",@"90",@"131",@"189",@"218",@"232",@"110"];
    NSArray * greenArray = @[@"122",@"123",@"147",@"195",@"223",@"236",@"123"];
    NSArray * blueArray = @[@"255",@"197",@"179",@"199",@"235",@"241",@"254"];
...
andandPieChartColor:(UIColor *)andPieChartColor{
    ...
    // 小圆的中心点(折现起始点)
    ArcCentreCoordinate.x = ArcCenter.x+(PieChartRadius+20) * cos(RadianCentreCoordinate);
    ArcCentreCoordinate.y = ArcCenter.y+(PieChartRadius+20) * sin(RadianCentreCoordinate);
}
